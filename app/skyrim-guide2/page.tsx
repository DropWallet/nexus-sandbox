...
const SECTION_STORAGE_KEY = 'skyrim-guide2-section'

export default function SkyrimGuide2Page() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      const mapped = stored === 'introduction' ? 'setup' : stored
      if (guideSections.some((s) => s.id === mapped)) {
          ...
          <div className="min-w-0 flex-1 flex flex-col gap-6">
            ...
            <div className="min-h-[400px] flex flex-col">
              ...
              {(() => {
                ...
                if (section.id === 'add-skyrim-to-vortex') {
                  const g = (n: number) => `/guides/section2-image${n}.png`
                  return (
                    <>
                      <div className="pb-[var(--spacing-10)]">
                        ...
                        <div className="flex flex-col gap-2 pt-0">
                          <Typography variant="body-xl" className="text-neutral-subdued [&_em]:italic [&_em]:text-neutral-moderate [&_em]:font-semibold">
                            Click on <em>Select a game to manage</em>.
                          </Typography>
                        </div>
                        <div className="flex flex-col gap-2 py-6">
                          <GuideImage
